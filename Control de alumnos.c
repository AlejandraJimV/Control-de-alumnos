/*
Creado por Alejandra Jiménez Venegas 
Estructuras de Datos 
Este código es un ejemplo de cómo gestionar una lista de alumnos utilizando estructuras de datos dinámicas en C.
La combinación de funciones para manipular la lista y la interacción con el 
usuario permite crear un sistema funcional para el manejo de datos académicos.*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <windows.h>
...
void abrir(struct Nodo** lista, size_t tamanoDatos, const char* nombreArchivo) {
    ...
    *lista = NULL;
    ...
    while (fgets(linea, sizeof(linea), archivo) != NULL) {
        ...
        i++;
        // Imprimir las l�neas del archivo
        gotoxy(5, 5 + i);
        printf("%s", linea);
...
void mostrarMatriculas(struct Nodo* lista) {
    ...
    while (lista != NULL) {
        ...
        int lon = snprintf(NULL, 0, "%d", alumno->matricula); // Calcular longitud del n�mero
